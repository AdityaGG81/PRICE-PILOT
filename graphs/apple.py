...
st.set_page_config(layout="wide", page_title="iPhone 15 Price Tracker")
...
try:
    query = "SELECT * FROM view_apple_iphone_15_128gb"
...
if df.empty:
    st.warning("No data available for iPhone 15 128GB.")
    st.stop()
