...
st.set_page_config(layout="wide", page_title="Samsung Watch Price Tracker")
...
html_title = """
    ...
    <center><h1 class="title-test">SAMSUNG WATCH PRICE COMPARISON</h1></center>
"""
...
# Create a row with three columns for filter placement
...
if df.empty:
    st.warning("No data available for Samsung Watch.")
    st.stop()
